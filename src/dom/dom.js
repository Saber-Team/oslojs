/**
 * @fileoverview 一组函数用于操作浏览器的DOM本文的很多实现采用了来自mochikit
 *     (http://mochikit.com/)的实现方式.
 * @modified Leo.Zhang
...
define('Sogou.Dom.Util',
    ...
    function(util, object, array, ua, string, Size, Coordinate, NodeType, classes, BrowserFeature) {
        ...
        function getTextContent(node) {
            ...
            // 去除 &shy; 实体. Sogou.Format.insertWordBreaks 会在Opera下不慎插入.
            textContent = textContent.replace(/ \xAD /g, ' ').replace(/\xAD/g, '');
            // 去除 &#8203; 实体. Sogou.Format.insertWordBreaks 会在IE8下不慎插入.
            // 具体可以看看这个：
