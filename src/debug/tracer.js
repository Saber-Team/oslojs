...
define([
  ...
  function(util, array, iter, log, Map, SimplePool) {
    ...
    /**
     * Class used for singleton debug.Trace.  Used for timing slow points in
     ...
     * @private
     */
    Trace_.prototype.logger_ = log.getLogger('Oslo.debug.Trace');
     ...
     */
    Trace_.Event_.prototype.toTraceString = function(startTime, prevTime,
                                                     indent) {
      var sb = [];
     ...
     */
    Trace_.prototype.addComment = function(comment, opt_type,
                                           opt_timeStamp) {
      var now = Trace_.now();
      var timeStamp = opt_timeStamp ? opt_timeStamp : now;

      var eventComment = /** @type {Trace_.Event_} */ (
        this.eventPool_.getObject());
